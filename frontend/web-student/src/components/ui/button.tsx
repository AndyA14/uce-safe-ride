  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-xl text-sm font-semibold ring-offset-background transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        accent: "gradient-accent text-white shadow-md hover:shadow-accent-glow active:scale-[0.98]",
        hero: "gradient-primary text-white shadow-lg hover:shadow-xl active:scale-[0.98] text-base",
        glass: "glass-card text-foreground hover:bg-white/80 border-white/40 active:scale-[0.98]",
        panic: "bg-destructive text-destructive-foreground shadow-lg hover:shadow-accent-glow animate-pulse hover:animate-none active:scale-[0.98]",
      ...
      size: {
        ...
        "icon-xl": "h-20 w-20 rounded-3xl text-2xl",
      },
    },
    defaultVariants: {
      variant: "default",
