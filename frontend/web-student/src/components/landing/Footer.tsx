        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10">
          ...
          <div className="md:col-span-2">
            <div className="flex items-center gap-3 mb-4">
              <img src={uceLogo} alt="UCE Logo" className="w-12 h-12 bg-white rounded-full p-0.5" />
              <span className="font-bold text-xl">UCE Safe Ride</span>
            </div>
            <p className="text-white/70 leading-relaxed mb-6 max-w-md">
              Sistema de transporte inteligente universitario. Conectando estudiantes 
              con su destino de forma segura y eficiente.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className="flex items-center gap-3 text-white/70">
                ...
                <span>soporte@uce.edu.ec</span>
              </li>
              <li className="flex items-center gap-3 text-white/70">
                <Phone className="w-5 h-5" />
                <span>+593 2 252 6810</span>
              </li>
              <li className="flex items-start gap-3 text-white/70">
                <MapPin className="w-5 h-5 mt-0.5" />
                <span>Av. América, Quito, Ecuador</span>
              </li>
            </ul>
          </div>
        </div>
